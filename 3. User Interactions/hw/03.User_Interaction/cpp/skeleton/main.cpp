...
void compose_imgui_frame()
{
  ...
  // control window
  {
    ...
    ImGui::SliderFloat("  ", &g_vec_model_translate[0], -1.0f, 1.0f);
    ImGui::PopID();

    ImGui::PushID("y");
    ImGui::SetNextItemWidth(100.0f);
    ImGui::SameLine();
    ImGui::SliderFloat("  ", &g_vec_model_translate[1], -1.0f, 1.0f);
    ImGui::PopID();

    ImGui::SetNextItemWidth(100.0f);
    ImGui::SameLine();
    ImGui::SliderFloat("translate", &g_vec_model_translate[2], -1.0f, 1.0f);
    ...
    ImGui::PushID("xScale");
    ImGui::SetNextItemWidth(100.0f);
    ImGui::SliderFloat("  ", &g_vec_model_scale[0], -3.0f, 3.0f);
    ImGui::PopID();

    ImGui::PushID("yScale");
    ImGui::SetNextItemWidth(100.0f);
    ImGui::SameLine();
    ImGui::SliderFloat("  ", &g_vec_model_scale[1], -3.0f, 3.0f);
    ImGui::PopID();

    ImGui::SetNextItemWidth(100.0f);
    ImGui::SameLine();
    ImGui::SliderFloat("scale", &g_vec_model_scale[2], -3.0f, 3.0f);
...
void init_scene()
{
  ...
  g_quat_model_rotation = glm::quat_cast(glm::mat3(1.0f));
